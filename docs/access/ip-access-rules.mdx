...
description: "One valuable way to prevent unauthorized data access is to restrict access to clinical data by the user's IP address. This article will discuss the benefits of IP address restrictions and provide a step-by-step guide on configuring these settings in Medplum's ."
---

## Importance of IP Address Restrictions[​](#importance-of-ip-address-restrictions "Direct link to Importance of IP Address Restrictions")
...
## Setting Up IP Address Restrictions in Medplum[​](#setting-up-ip-address-restrictions-in-medplum "Direct link to Setting Up IP Address Restrictions in Medplum")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/access/ip-access-rules.md)
