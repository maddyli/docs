...
description: "There are two primary ways to configure the Medplum server when self-hosting: through a JSON configuration file or by using environment variables. This guide will walk you through both methods."
---

## JSON Configuration File[​](#json-configuration-file "Direct link to JSON Configuration File")
...
### Example `medplum.config.json`[​](#example-medplumconfigjson "Direct link to example-medplumconfigjson")

```
{  "baseUrl": "http://localhost:8103/",  "port": 8103,  "database": {    "host": "localhost",    "port": 5432,    "dbname": "medplum",    "username": "medplum",    "password": "medplum"  },  "redis": {    "host": "localhost",    "port": 6379  }}
```
...
```
export MEDPLUM_BASE_URL="http://localhost:8103/"export MEDPLUM_PORT=8103export MEDPLUM_DATABASE_HOST="localhost"export MEDPLUM_DATABASE_PORT=5432export MEDPLUM_DATABASE_DBNAME="medplum"export MEDPLUM_DATABASE_USERNAME="medplum"export MEDPLUM_DATABASE_PASSWORD="medplum"export MEDPLUM_REDIS_HOST="localhost"export MEDPLUM_REDIS_PORT=6379
```

### Case Sensitivity and Underscores[​](#case-sensitivity-and-underscores "Direct link to Case Sensitivity and Underscores")
...
## AWS Systems Manager (SSM) Parameter Store[​](#aws-systems-manager-ssm-parameter-store "Direct link to AWS Systems Manager (SSM) Parameter Store")
...
### Automated Parameters (CDK)[​](#automated-parameters-cdk "Direct link to Automated Parameters (CDK)")
...
### Manual Parameters[​](#manual-parameters "Direct link to Manual Parameters")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/self-hosting/setting-configuration.md)
