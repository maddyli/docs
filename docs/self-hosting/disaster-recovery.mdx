...
description: "This document outlines a high-level approach to disaster recovery for a self-hosted Medplum instance deployed across various infrastructure options, including cloud providers (AWS, GCP, Azure) and Kubernetes. It is intended as a foundational overview to facilitate discussions and planning, rather than a detailed step-by-step runbook."
---
...
## Key Principles of Medplum Disaster Recovery[​](#key-principles-of-medplum-disaster-recovery "Direct link to Key Principles of Medplum Disaster Recovery")
...
## High-Level Recovery Steps[​](#high-level-recovery-steps "Direct link to High-Level Recovery Steps")
...
## Important Considerations and Next Steps[​](#important-considerations-and-next-steps "Direct link to Important Considerations and Next Steps")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/self-hosting/disaster-recovery.md)
