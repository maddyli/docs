...
description: "When self-hosting a Medplum server, you will have access to a \"Super Admin\" project. When you sign in as a member of the \"Super Admin\" project, you will have access to very powerful super admin privileges."
---
...
## Protected Resources[​](#protected-resources "Direct link to Protected Resources")
...
## Server Maintenance[​](#server-maintenance "Direct link to Server Maintenance")
...
### Rebuild Resources[​](#rebuild-resources "Direct link to Rebuild Resources")
...
### Reindex Resources[​](#reindex-resources "Direct link to Reindex Resources")
...
### Rebuild Compartments[​](#rebuild-compartments "Direct link to Rebuild Compartments")
...
### Purge Resources[​](#purge-resources "Direct link to Purge Resources")
...
### Force Set Password[​](#force-set-password "Direct link to Force Set Password")
...
### Inviting Users to Projects[​](#inviting-users-to-projects "Direct link to Inviting Users to Projects")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/self-hosting/super-admin-guide.md)
