...
description: "As your project grows, you may need to upgrade your RDS database instance size. This document describes how to perform this operation with zero downtime."
---
...
## Step 1: Confirm multiple database instances[​](#step-1-confirm-multiple-database-instances "Direct link to Step 1: Confirm multiple database instances")
...
## Step 2: Upgrade the reader instances[​](#step-2-upgrade-the-reader-instances "Direct link to Step 2: Upgrade the reader instances")
...
## Step 3: Upgrade the writer instances[​](#step-3-upgrade-the-writer-instances "Direct link to Step 3: Upgrade the writer instances")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/self-hosting/upgrade-rds-database.md)
