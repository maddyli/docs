...
description: "Keeping your Medplum server up-to-date ensures you get the latest security patches, new features, and performance improvements while maintaining compliance with healthcare regulations."
---
...
## Step-by-Step Upgrade Process[​](#step-by-step-upgrade-process "Direct link to Step-by-Step Upgrade Process")

### 1. Plan Your Upgrade Path[​](#1-plan-your-upgrade-path "Direct link to 1. Plan Your Upgrade Path")
...
### 2. Handle Breaking Changes (Major Versions Only)[​](#2-handle-breaking-changes-major-versions-only "Direct link to 2. Handle Breaking Changes (Major Versions Only)")
...
### 3. Deploy Each Version[​](#3-deploy-each-version "Direct link to 3. Deploy Each Version")
...
## Monitoring Migration Progress[​](#monitoring-migration-progress "Direct link to Monitoring Migration Progress")

### Using the Admin Panel (available after [v4.1.12+](https://github.com/medplum/medplum/pull/6862))[​](#using-the-admin-panel-available-after-v4112 "Direct link to using-the-admin-panel-available-after-v4112")
...
## Understanding Database Migrations[​](#understanding-database-migrations "Direct link to Understanding Database Migrations")

Medplum uses two types of migrations to minimize downtime:

### Pre-deploy Migrations[​](#pre-deploy-migrations "Direct link to Pre-deploy Migrations")
...
### Post-deploy Migrations[​](#post-deploy-migrations "Direct link to Post-deploy Migrations")
...
### Server Won't Start After Upgrade[​](#server-wont-start-after-upgrade "Direct link to Server Won't Start After Upgrade")
...
### Migration Taking Too Long[​](#migration-taking-too-long "Direct link to Migration Taking Too Long")
...
### Skipped a Minor Version[​](#skipped-a-minor-version "Direct link to Skipped a Minor Version")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/self-hosting/upgrading-server.md)
