...
description: "You've decided to self-host Medplum — great. This guide covers operational practices that will help you run a stable, maintainable deployment and set yourself up for long-term success."
---
...
## Infrastructure Organization[​](#infrastructure-organization "Direct link to Infrastructure Organization")

### Use a Dedicated Cloud Account[​](#use-a-dedicated-cloud-account "Direct link to Use a Dedicated Cloud Account")
...
## Database Management[​](#database-management "Direct link to Database Management")

### Treat the Database as Sacred[​](#treat-the-database-as-sacred "Direct link to Treat the Database as Sacred")
...
### Plan for PostgreSQL Major Version Upgrades[​](#plan-for-postgresql-major-version-upgrades "Direct link to Plan for PostgreSQL Major Version Upgrades")
...
## Observability and Monitoring[​](#observability-and-monitoring "Direct link to Observability and Monitoring")
...
### Minimum Viable Monitoring[​](#minimum-viable-monitoring "Direct link to Minimum Viable Monitoring")
...
### Recommended Additions[​](#recommended-additions "Direct link to Recommended Additions")
...
### Tooling Options[​](#tooling-options "Direct link to Tooling Options")
...
### Don't Run Hot[​](#dont-run-hot "Direct link to Don't Run Hot")
...
### Connection Limits[​](#connection-limits "Direct link to Connection Limits")
...
### Verify Your Backups[​](#verify-your-backups "Direct link to Verify Your Backups")
...
### Multi-AZ and Redundancy[​](#multi-az-and-redundancy "Direct link to Multi-AZ and Redundancy")
...
## Security Hygiene[​](#security-hygiene "Direct link to Security Hygiene")

### Network Architecture[​](#network-architecture "Direct link to Network Architecture")
...
### Patching Cadence[​](#patching-cadence "Direct link to Patching Cadence")
...
## Upgrade Strategy[​](#upgrade-strategy "Direct link to Upgrade Strategy")

### Stay Reasonably Current[​](#stay-reasonably-current "Direct link to Stay Reasonably Current")
...
### Maintain a Staging Environment[​](#maintain-a-staging-environment "Direct link to Maintain a Staging Environment")
...
### Subscribe to Release Notifications[​](#subscribe-to-release-notifications "Direct link to Subscribe to Release Notifications")
...
## Document Your Customizations[​](#document-your-customizations "Direct link to Document Your Customizations")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/self-hosting/best-practices.md)
