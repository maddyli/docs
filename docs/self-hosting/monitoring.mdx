...
description: "When running a self-hosted Medplum instance, proper monitoring is essential for maintaining system health and performance. This guide covers the key metrics Medplum recommends self-hosting users to track and what information they surface about your deployment."
---
...
## Server-Level Metrics[​](#server-level-metrics "Direct link to Server-Level Metrics")

These metrics come directly from the Medplum server and provide the most comprehensive view of application behavior. Specifically, these are OpenTelemetry metrics, and the exact names of those metrics are included below; see [our OTel doc](/docs/self-hosting/opentelemetry) for a configuration guide and more details.

### Connection Health[​](#connection-health "Direct link to Connection Health")
...
### Subscription Processing[​](#subscription-processing "Direct link to Subscription Processing")
...
### Traffic and Performance[​](#traffic-and-performance "Direct link to Traffic and Performance")
...
## Database Metrics[​](#database-metrics "Direct link to Database Metrics")
...
### Query Efficiency[​](#query-efficiency "Direct link to Query Efficiency")
...
## Cache Metrics (Redis)[​](#cache-metrics-redis "Direct link to Cache Metrics (Redis)")
...
## Container Metrics[​](#container-metrics "Direct link to Container Metrics")
...
### CPU Considerations for Node.js[​](#cpu-considerations-for-nodejs "Direct link to CPU Considerations for Node.js")
...
## Alerting Strategy[​](#alerting-strategy "Direct link to Alerting Strategy")

### High-Priority Alerts[​](#high-priority-alerts "Direct link to High-Priority Alerts")
...
### Supporting Alerts[​](#supporting-alerts "Direct link to Supporting Alerts")
...
### Alert Tuning[​](#alert-tuning "Direct link to Alert Tuning")
...
## Monitoring Best Practices[​](#monitoring-best-practices "Direct link to Monitoring Best Practices")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/self-hosting/monitoring.md)
