...
description: "Many settings are also available at the Project level, allowing them to be configured for specific tenants on the server rather than globally. Only Super Admin users are allowed to edit Project settings."
---
...
## Project feature flags[​](#project-feature-flags "Direct link to Project feature flags")
...
## Project system settings[​](#project-system-settings "Direct link to Project system settings")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/self-hosting/project-settings.md)
