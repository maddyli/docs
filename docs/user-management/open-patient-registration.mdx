...
## Enabling Open Patient Registration[​](#enabling-open-patient-registration "Direct link to Enabling Open Patient Registration")
...
2. **Set the [`AccessPolicy`](/docs/api/fhir/medplum/accesspolicy) as the default** - Navigate to [https://app.medplum.com/Project](https://app.medplum.com/Project) and select your project. In the "Edit" tab, set the "Default Patient Access Policy" field to your new policy and click "Update".

[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/user-management/open-patient-registration.md)
