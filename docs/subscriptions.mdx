---
title: "Overview"
description: "Subscriptions are event-driven notifications, like webhooks, and are commonly used for integrations and automations. Medplum supports subscribing to changes on FHIR resources. There is a description  on HL7.org that describes the functionality in detail."
---
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/subscriptions/index.md)
