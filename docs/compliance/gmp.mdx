...
description: "Good Manufacturing Practices (GMP) are a set of guidelines, regulations, and quality management systems designed to ensure that products, particularly pharmaceuticals, medical devices, and food products, are consistently manufactured, controlled, and tested according to established quality standards."
---
...
## GMP Controls[​](#gmp-controls "Direct link to GMP Controls")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/compliance/gmp.md)
