---
title: "HTI-4"
description: "The \"Health Data, Technology, and Interoperability\" (HTI-4) rule is a new ONC regulation finalized on July 31, 2025, becoming effective October 1, 2025. This rule modernizes the entire prescribing workflow by mandating new technical certifications across all certified health IT systems, shifting key interoperability functions from optional features to mandatory requirements for certification."
---
...
## Technical Mandates[​](#technical-mandates "Direct link to Technical Mandates")
...
### e-Prescribing (eRx) Update[​](#e-prescribing-erx-update "Direct link to e-Prescribing (eRx) Update")
...
### Real-Time Prescription Benefit (RTPB)[​](#real-time-prescription-benefit-rtpb "Direct link to Real-Time Prescription Benefit (RTPB)")
...
### Electronic Prior Authorization (ePA)[​](#electronic-prior-authorization-epa "Direct link to Electronic Prior Authorization (ePA)")
...
### Healthcare Providers[​](#healthcare-providers "Direct link to Healthcare Providers")
...
### Payers (Health Plans)[​](#payers-health-plans "Direct link to Payers (Health Plans)")
...
## Compliance Timeline[​](#compliance-timeline "Direct link to Compliance Timeline")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/compliance/hti-4.md)
