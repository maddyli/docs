...
## Release Schedule[​](#release-schedule "Direct link to Release Schedule")

### Major Versions (X.0.0)[​](#major-versions-x00 "Direct link to Major Versions (X.0.0)")
...
* *Availability of a new major in Q4 does **not** require immediate adoption; customers may remain on the previous major for its entire Active + Maintenance (+ Enterprise extension, if applicable) window.*
...
### Minor Versions (X.Y.0)[​](#minor-versions-xy0 "Direct link to Minor Versions (X.Y.0)")
...
* *The `medplum upgrade` / `medplum aws upgrade` tool automatically chains sequential minors (e.g., 5.0 → 5.3) and supports transactional rollback.*

### Patch Versions (X.Y.Z)[​](#patch-versions-xyz "Direct link to Patch Versions (X.Y.Z)")
...
### Security Patch SLA[​](#security-patch-sla "Direct link to Security Patch SLA")
...
## Dependency Support[​](#dependency-support "Direct link to Dependency Support")

### Scheduled Release Dependencies[​](#scheduled-release-dependencies "Direct link to Scheduled Release Dependencies")
...
### Other Major Dependencies[​](#other-major-dependencies "Direct link to Other Major Dependencies")
...
* *Baseline versions are otherwise frozen for that major; bumps occur only to remediate critical CVEs and will be announced ≥ 30 days in advance.*

## FHIR Roadmap Alignment[​](#fhir-roadmap-alignment "Direct link to FHIR Roadmap Alignment")
...
## Deprecation & Removal Policy[​](#deprecation--removal-policy "Direct link to Deprecation & Removal Policy")
...
### Enterprise Considerations[​](#enterprise-considerations "Direct link to Enterprise Considerations")
...
#### Maintenance Support[​](#maintenance-support "Direct link to Maintenance Support")
...
#### Advance Change Notice[​](#advance-change-notice "Direct link to Advance Change Notice")
...
## Version Lifecycle Example[​](#version-lifecycle-example "Direct link to Version Lifecycle Example")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/compliance/versions.md)
