...
description: "This guide provides a comprehensive reference for the most commonly used code systems and valuesets in healthcare applications. Each section includes the FHIR  URLs needed for proper coding in FHIR resources."
---

## Overview of Common Code Systems[​](#overview-of-common-code-systems "Direct link to Overview of Common Code Systems")
...
## Use-case Specific ValueSets[​](#use-case-specific-valuesets "Direct link to Use-case Specific ValueSets")
...
### Clinical Findings and Laboratory Tests[​](#clinical-findings-and-laboratory-tests "Direct link to Clinical Findings and Laboratory Tests")
...
### Allergies and Adverse Reactions[​](#allergies-and-adverse-reactions "Direct link to Allergies and Adverse Reactions")
...
### Medications[​](#medications "Direct link to Medications")
...
### Medical Procedures[​](#medical-procedures "Direct link to Medical Procedures")
...
### Diagnoses and Conditions[​](#diagnoses-and-conditions "Direct link to Diagnoses and Conditions")
...
### Vaccines and Immunizations[​](#vaccines-and-immunizations "Direct link to Vaccines and Immunizations")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/terminology/common-terminologies.md)
