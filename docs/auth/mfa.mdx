...
## Self-Enrollment[​](#self-enrollment "Direct link to Self-Enrollment")

Users can self-enroll in MFA through the Medplum App security settings.

### Steps to Self-Enroll[​](#steps-to-self-enroll "Direct link to Steps to Self-Enroll")
...
![MFA Enrollment Screen](/images/docs/auth/assets/images/mfa-enrollment-1d96587398a6a2957b28f09082b28c5b.png)
...
## Requiring MFA for New Users[​](#requiring-mfa-for-new-users "Direct link to Requiring MFA for New Users")
...
### Example: Inviting a User with MFA Required[​](#example-inviting-a-user-with-mfa-required "Direct link to Example: Inviting a User with MFA Required")

<Tabs>
  <Tab title="TypeScript">
    ```
    await medplum.invite(123, {  resourceType: 'Practitioner',  firstName: 'Jane',  lastName: 'Doe',  email: 'jane.doe@example.com',  mfaRequired: true,});
    ```
  </Tab>
...
## Using Medplum's SignInForm Component[​](#using-medplums-signinform-component "Direct link to Using Medplum's SignInForm Component")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/auth/mfa.md)
