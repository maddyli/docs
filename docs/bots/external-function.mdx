...
description: "When running Medplum in AWS, Medplum uses AWS Lambdas to execute bot logic."
---
...
```
{  "resourceType": "Bot",  "identifier": [    {      "system": "https://medplum.com/bot-external-function-id",      "value": "my-custom-lambda-function"    }  ],  "name": "External Demo Bot",  "runtimeVersion": "awslambda"}
```

## Deploy the bot[​](#deploy-the-bot "Direct link to Deploy the bot")
...
## Execute the bot[​](#execute-the-bot "Direct link to Execute the bot")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/bots/external-function.md)
