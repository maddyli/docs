...
## Planning your integration[​](#planning-your-integration "Direct link to Planning your integration")
...
### Using TypeScript SDKs in your bot[​](#using-typescript-sdks-in-your-bot "Direct link to Using TypeScript SDKs in your bot")
...
## Creating Access Policies[​](#creating-access-policies "Direct link to Creating Access Policies")
...
```
{  "resourceType": "AccessPolicy",  "name": "Stripe Webhook Access Policy",  "resource": [    {      "resourceType": "Bot",      "readonly": true    }  ]}
```
...
```
{  "resourceType": "AccessPolicy",  "name": "Stripe Bot Access Policy",  "resource": [    {      "resourceType": "Invoice"    },    {      "resourceType": "Account"    }  ]}
```

## Configuring Webhooks in another Application[​](#configuring-webhooks-in-another-application "Direct link to Configuring Webhooks in another Application")
...
## Authenticating Payloads[​](#authenticating-payloads "Direct link to Authenticating Payloads")
...
## Unauthenticated Webhooks[​](#unauthenticated-webhooks "Direct link to Unauthenticated Webhooks")
...
### How to Set Up an Unauthenticated Webhook[​](#how-to-set-up-an-unauthenticated-webhook "Direct link to How to Set Up an Unauthenticated Webhook")
...
2. **Implement Signature Verification in your Bot:** Your Bot's code should include logic to verify the incoming signature from the third-party service. This typically involves using a shared secret (stored as a Bot secret) and a hashing algorithm.

3. **Configure the Webhook URL in the Third-Party Service:** Use the Medplum webhook endpoint format (`https://api.medplum.com/webhook/{ProjectMembership.id}`) in your third-party service's webhook configuration.

4. **Test the Webhook Integration:** Use the third-party service's test tools to send a sample webhook notification and verify that your Medplum Bot executes correctly and processes the payload as expected. Check your Bot's logs for any errors related to signature verification or Access Policy.

## Monitoring your integration[​](#monitoring-your-integration "Direct link to Monitoring your integration")
...
* [bots](/docs/tags/bots)
* [subscriptions](/docs/tags/subscriptions)
* [auth](/docs/tags/auth)
* [security](/docs/tags/security)

[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/bots/consuming-webhooks.md)
