---
title: "The  Tab"
description: "The Medplum App allows for easy integration of workflows and third-party applications using the  tab. It is important to reiterate that the Medplum App is targeted towards developers and the  tab is primarily a tool to help with developer automation."
---
...
## Navigating to the `Apps` Tab[​](#navigating-to-the-apps-tab "Direct link to navigating-to-the-apps-tab")

To get to the `Apps` tab of, for example, a patient go to the `Patient` resources page by clicking Patient on the left sidebar of the app or navigating to [https://app.medplum.com/Patient](https://app.medplum.com/Patient).
...
![Apps Tab](/images/docs/app/assets/images/apps-tab-76386399e103749860e1752b90ee2f4e.png)

Alternatively, you can navigate directly to this page at [https://app.medplum.com/Patient/:id/apps](https://app.medplum.com/Patient/:id/apps).

## Questionnaires[​](#questionnaires "Direct link to Questionnaires")
...
## SMART App Launch[​](#smart-app-launch "Direct link to SMART App Launch")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/app/apps-tab.md)
