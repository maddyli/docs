---
title: "Invite a user"
description: "This guide explains how to invite another user to your Medplum project."
---

![Admin Users Page](/images/docs/app/assets/images/admin-users-page-49219fbd3ecb20f3b0f9041538ffe87a.png)

1. Open the Medplum app in your browser: [https://app.medplum.com/](https://app.medplum.com/). If you don't have an account yet, see the [Register](/docs/tutorials/register) page.
...
![Invite New User](/images/docs/app/assets/images/invite-new-user-4f54df8d76fad4488dab50d1bf990917.png)
...
9. You can optionally add the new user as a Project Administrator by checking the "Admin" checkbox. See the [User Admin Guide](/docs/user-management#user-administration-via-medplum-app) for more details and how to do this using the API.
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/app/invite/invite.md)
