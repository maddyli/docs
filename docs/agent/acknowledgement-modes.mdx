...
description: "HL7 Acknowledgement Modes define the handshaking protocol between systems exchanging messages over protocols like MLLP. The  supports both  and  modes, allowing you to configure connections for optimal throughput and reliability."
---

Support for Enhanced Acknowledgement Mode was added in **Medplum Server version 3.1.9** and **Medplum Agent version 4.1.8**.

## Overview of HL7 Acknowledgements (ACKs)[​](#overview-of-hl7-acknowledgements-acks "Direct link to Overview of HL7 Acknowledgements (ACKs)")
...
### The Purpose of Acknowledgements[​](#the-purpose-of-acknowledgements "Direct link to The Purpose of Acknowledgements")
...
## Original Acknowledgement Mode[​](#original-acknowledgement-mode "Direct link to Original Acknowledgement Mode")
...
### How Original Mode Works[​](#how-original-mode-works "Direct link to How Original Mode Works")
...
### The Bottleneck[​](#the-bottleneck "Direct link to The Bottleneck")
...
## Enhanced Acknowledgement Mode (Fast ACK)[​](#enhanced-acknowledgement-mode-fast-ack "Direct link to Enhanced Acknowledgement Mode (Fast ACK)")
...
### How Enhanced Mode Works (Two-Step Process)[​](#how-enhanced-mode-works-two-step-process "Direct link to How Enhanced Mode Works (Two-Step Process)")

#### Step 1: Accept Acknowledgement (The Fast Response)[​](#step-1-accept-acknowledgement-the-fast-response "Direct link to Step 1: Accept Acknowledgement (The Fast Response)")
...
#### Step 2: Application Acknowledgement (The Processing Result)[​](#step-2-application-acknowledgement-the-processing-result "Direct link to Step 2: Application Acknowledgement (The Processing Result)")
...
### MSH Configuration for Enhanced Mode[​](#msh-configuration-for-enhanced-mode "Direct link to MSH Configuration for Enhanced Mode")

The choice of acknowledgement mode is negotiated using two fields in the MSH segment of the HL7 message:

* **MSH-15 (Accept Acknowledgment Type):** Dictates when the Sender expects the *Accept ACK* (CA/CE/CR).
* **MSH-16 (Application Acknowledgment Type):** Dictates when the Sender expects the *Application ACK* (AA/AE/AR).
...
### Compatibility Caution[​](#compatibility-caution "Direct link to Compatibility Caution")
...
## AA Mode (Simplified Enhanced Mode)[​](#aa-mode-simplified-enhanced-mode "Direct link to AA Mode (Simplified Enhanced Mode)")
...
### How AA Mode Works[​](#how-aa-mode-works "Direct link to How AA Mode Works")
...
### When to Use AA Mode[​](#when-to-use-aa-mode "Direct link to When to Use AA Mode")
...
| *(not set)*     | Original Mode     | *(none)*      | Yes (AA/AE/AR)            |

### Comparison: Standard Enhanced vs AA Mode[​](#comparison-standard-enhanced-vs-aa-mode "Direct link to Comparison: Standard Enhanced vs AA Mode")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/agent/acknowledgement-modes.md)
