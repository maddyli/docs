...
description: "Medplum publishes an official agent installer for Microsoft Windows."
---
...
### Operating System (OS)[​](#operating-system-os "Direct link to Operating System (OS)")

* **Minimum OS**: Microsoft Windows 8.1 or Windows Server 2012 R2
* **Recommended OS**: Microsoft Windows 11 or Windows Server 2022

### Random Access Memory (RAM)[​](#random-access-memory-ram "Direct link to Random Access Memory (RAM)")
...
### Central Processing Unit (CPU)[​](#central-processing-unit-cpu "Direct link to Central Processing Unit (CPU)")
...
### Disk Storage[​](#disk-storage "Direct link to Disk Storage")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/agent/requirements.md)
