...
description: "The key to success for any data migration is planning. It is critical to know the data, know the systems, and communication with all stakeholders. The planning process begins before you write a single line of code."
---
...
## Adoption Strategies[​](#adoption-strategies "Direct link to Adoption Strategies")

### Phased Adoption[​](#phased-adoption "Direct link to Phased Adoption")
...
### Big Bang Adoption[​](#big-bang-adoption "Direct link to Big Bang Adoption")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/migration/migration-planning.md)
