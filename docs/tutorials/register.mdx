...
description: "This guide explains how to register for a new Medplum account and create your first Medplum project."
---

## Register for a Medplum account[​](#register-for-a-medplum-account "Direct link to Register for a Medplum account")

* Open the Medplum register page in your browser: [https://app.medplum.com/register](https://app.medplum.com/register)
...
## Medplum projects[​](#medplum-projects "Direct link to Medplum projects")
...
## Explore your new project[​](#explore-your-new-project "Direct link to Explore your new project")
...
![Top left menu](/images/docs/tutorials/assets/images/top-left-menu-aad540303f38f0aa43b9463ca36c990c.png)

## Invite a new user[​](#invite-a-new-user "Direct link to Invite a new user")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/tutorials/register.md)
