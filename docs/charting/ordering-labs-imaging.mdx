...
description: "Certified EHRs are required to support Computerized Physician Order Entry (CPOE) for Medications Labs and/or Imaging. These correspond to the ONC (a)(1), (a)(2) and (a)(3) criteria and which are described on ."
---
...
## Order Form[​](#order-form "Direct link to Order Form")
...
## Common Diagnostics Providers[​](#common-diagnostics-providers "Direct link to Common Diagnostics Providers")
...
## Logistics[​](#logistics "Direct link to Logistics")
...
## Related Material[​](#related-material "Direct link to Related Material")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/charting/ordering-labs-imaging.md)
