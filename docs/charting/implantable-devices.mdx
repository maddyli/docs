...
description: "Capturing a Patient's implanted devices is a core function of an Electronic Health Record system. Requirements for EHR Implantable Device list are described in the ."
---
...
## Device Specific Identifiers[​](#device-specific-identifiers "Direct link to Device Specific Identifiers")
...
## Querying the FDA API[​](#querying-the-fda-api "Direct link to Querying the FDA API")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/charting/implantable-devices.md)
