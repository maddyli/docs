...
description: "Capturing Patient Demographics is a core function of an Electronic Health Record system. Requirements for EHR demographic capture are described in the ."
---
...
## Advanced Requirements[​](#advanced-requirements "Direct link to Advanced Requirements")
...
## Capturing Aliases[​](#capturing-aliases "Direct link to Capturing Aliases")
...
```
"name": [    {      "given": [        "Marge",        "Jacqueline"      ],      "family": "Simpson",      "period": {        "start": "1980-01-01T00:00:00Z"      },      "use": "official"    },    {      "given": [        "Marge",        "Jacqueline"      ],      "family": "née Bouvier",      "period": {        "end": "1980-01-01T00:00:00Z"      },      "use": "old"    }  ]
```

## Demographic Data[​](#demographic-data "Direct link to Demographic Data")
...
| Category  | Name                            | URL                                                                                                                                    |
| --------- | ------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| Gender    | Administrative Gender Value Set | [https://hl7.org/fhir/R4/valueset-administrative-gender.html](https://hl7.org/fhir/R4/valueset-administrative-gender.html)             |
| Race      | US Core Race Extension          | [http://hl7.org/fhir/us/core/StructureDefinition/us-core-race](http://hl7.org/fhir/us/core/StructureDefinition/us-core-race)           |
| Ethnicity | US Core ethnicity Extension     | [http://hl7.org/fhir/us/core/StructureDefinition/us-core-ethnicity](http://hl7.org/fhir/us/core/StructureDefinition/us-core-ethnicity) |
| Birth Sex | Birth sex Extension             | [http://hl7.org/fhir/us/core/StructureDefinition/us-core-birthsex](http://hl7.org/fhir/us/core/StructureDefinition/us-core-birthsex)   |
...
## Common Identifiers[​](#common-identifiers "Direct link to Common Identifiers")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/charting/patient-demographics.md)
