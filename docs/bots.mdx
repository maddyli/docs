---
title: "Overview"
description: "Medplum bots are functions that execute when triggered. They are similar to AWS Lambda functions, and in Medplum we make them easy to write and deploy and trigger with . For the purpose of the tutorials found in this section, it's important to understand that ."
---
...
<Warning>
  ...
  For users on the [Medplum Hosted Service](/pricing), bots are a paid features. Contact [info@medplum.com](mailto:info@medplum.com) or reach out in our [Discord channel](https://discord.gg/medplum) to have Bots enabled on your project.
...
## Bot Triggers & Invocation[​](#bot-triggers--invocation "Direct link to Bot Triggers & Invocation")
...
## Common Use Cases & Patterns[​](#common-use-cases--patterns "Direct link to Common Use Cases & Patterns")
...
## Deployment & Infrastructure[​](#deployment--infrastructure "Direct link to Deployment & Infrastructure")
...
## Security & Permissions[​](#security--permissions "Direct link to Security & Permissions")
...
## Monitoring & Operations[​](#monitoring--operations "Direct link to Monitoring & Operations")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/bots/index.md)
