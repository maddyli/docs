---
title: "Analytics"
description: "When designing a healthcare analytics program, data quality and integrity are critical. To create a robust analytics program, constant monitoring of data quality and can be enabled and will be required to ensure that reports are meaningful and accurate."
---
...
## Program Design[​](#program-design "Direct link to Program Design")
...
| ----------------------------------------------------- | ---------------- | ------------------------------------------------------------------------------------ |
| Ad-hoc clinical reports                               | Retrospective    | FHIR Datastore, including [Bulk](/docs/api/fhir/operations/bulk-fhir) and Batch APIs |
...
## Ad-Hoc Clinical Reports[​](#ad-hoc-clinical-reports "Direct link to Ad-Hoc Clinical Reports")
...
Analytics pipelines should use the [FHIR Bulk Data Export API](/docs/api/fhir/operations/bulk-fhir) to extract FHIR resources into a data lake. The [FHIR Datastore](/docs/fhir-datastore) supports bulk export.
...
## Healthcare Standard Reports[​](#healthcare-standard-reports "Direct link to Healthcare Standard Reports")
...
### HEDIS[​](#hedis "Direct link to HEDIS")
...
### CMS Measures[​](#cms-measures "Direct link to CMS Measures")
...
## Clinical Decision Support[​](#clinical-decision-support "Direct link to Clinical Decision Support")
...
## Machine Learning / Predictive Modeling[​](#machine-learning--predictive-modeling "Direct link to Machine Learning / Predictive Modeling")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/analytics/index.md)
