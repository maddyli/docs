...
description: "This tutorial will walk through how to create a  and generate a  using the Medplum console app. The  and  resources are very common in implementations and are used to drive patient-facing and provider-facing experiences."
---

## Upload Questionnaire[​](#upload-questionnaire "Direct link to Upload Questionnaire")
...
## View Questionnaire[​](#view-questionnaire "Direct link to View Questionnaire")
...
## Try Questionnaire[​](#try-questionnaire "Direct link to Try Questionnaire")
...
## View QuestionnaireResponse[​](#view-questionnaireresponse "Direct link to View QuestionnaireResponse")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/questionnaires/basic-tutorial.md)
