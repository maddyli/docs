...
description: "This is the process we use to publish new versions of JavaScript NPM packages."
---
...
### 1. Prepare the release[​](#1-prepare-the-release "Direct link to 1. Prepare the release")
...
### 2. Publish the release[​](#2-publish-the-release "Direct link to 2. Publish the release")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/contributing/publishing-npm-packages.md)
