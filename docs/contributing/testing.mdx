---
title: "Testing"
description: "Medplum strongly believes in the importance of testing."
---
...
```
npm t -- --coveragenpm t -- src/App.test.tsx --coveragenpm t -- src/App.test.tsx -t 'Click logo' --coverage
```

[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/contributing/testing.md)
