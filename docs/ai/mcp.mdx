---
title: "Medplum MCP"
description: "Welcome to the official documentation for the Medplum MCP integration. This guide provides an in-depth look at how to set up and use the integration, detailing the available tools and providing practical examples to help you get started."
---
...
3. **Add Integration:** Click "Add Integration" and enter the following details:
   ...
   * **Integration URL:** [https://api.medplum.com/mcp/stream](https://api.medplum.com/mcp/stream)
...
*Note: LLMs can sometimes cache sessions. If you experience issues, try disconnecting and reconnecting the integration in a new chat.*

### Core Functionality and Tools[​](#core-functionality-and-tools "Direct link to Core Functionality and Tools")
...
#### `fhir-request`[​](#fhir-request "Direct link to fhir-request")
...
```
{  "type": "object",  "properties": {    "method": {      "type": "string",      "enum": ["GET", "POST", "PUT", "PATCH", "DELETE"],      "description": "The HTTP method for the request."    },    "url": {      "type": "string",      "description": "The full FHIR API URL path (e.g., '/fhir/Patient')."    },    "body": {      "type": "object",      "description": "The JSON body of the FHIR resource to be created or updated."    }  },  "required": ["method", "url"]}
```
...
Medplum uses **OAuth 2.0 with the 6/18 auth spec** to securely authenticate users. When you first connect the integration, you will be redirected to the Medplum server to log in and authorize Claude.ai to access your data. Medplum's platform ensures all data access is secure and compliant with relevant healthcare regulations. Our full privacy policy can be found here: [https://www.medplum.com/privacy](https://www.medplum.com/privacy)

### Support and Community[​](#support-and-community "Direct link to Support and Community")
...
* **Discord:** [https://discord.gg/medplum](https://discord.gg/medplum)
* **Support Email:** [support@medplum.com](mailto:support@medplum.com)

[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/ai/mcp.md)
