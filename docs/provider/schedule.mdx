---
title: "Schedule"
description: "Effective schedule management is crucial for optimizing patient care delivery and clinic operations. The Medplum Provider app provides comprehensive scheduling tools to manage appointments, coordinate care, and maintain provider availability. This section covers the essential scheduling functions."
---

## Scheduling a Visit[​](#scheduling-a-visit "Direct link to Scheduling a Visit")
...
### How to Schedule a Visit[​](#how-to-schedule-a-visit "Direct link to How to Schedule a Visit")
...
## Setting Provider Availability[​](#setting-provider-availability "Direct link to Setting Provider Availability")
...
### How to Set Provider Availability[​](#how-to-set-provider-availability "Direct link to How to Set Provider Availability")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/provider/schedule.md)
