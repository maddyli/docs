...
description: "The Patient Profile section in the Medplum Provider app is your central hub for managing all patient-related information. This section covers how to register new patients, edit existing profiles, and maintain the  sidebar for quick access to key information."
---
...
### How to Register Patients[​](#how-to-register-patients "Direct link to How to Register Patients")
...
## Editing Patient Demographics[​](#editing-patient-demographics "Direct link to Editing Patient Demographics")
...
### How to Edit Patient Demographics[​](#how-to-edit-patient-demographics "Direct link to How to Edit Patient Demographics")
...
## Updating the Patient Summary Sidebar[​](#updating-the-patient-summary-sidebar "Direct link to Updating the Patient Summary Sidebar")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/provider/patient-profile.md)
