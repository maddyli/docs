---
title: "C-CDA"
description: "Medplum provides support for C-CDA (Consolidated Clinical Document Architecture) handling in accordance with the  criteria (g)(7), (g)(9) and (b)(1) as well as developer utilities for working with C-CDA documents in the context of FHIR."
---
...
## C-CDA Viewer[​](#c-cda-viewer "Direct link to C-CDA Viewer")
...
[YouTube video player](https://www.youtube.com/embed/Eg0-mu-UYAQ?start=0)

## Export C-CDA[​](#export-c-cda "Direct link to Export C-CDA")
...
## Transitions of Care[​](#transitions-of-care "Direct link to Transitions of Care")
...
[YouTube video player](https://www.youtube.com/embed/Ijjtf0ClZDA?start=0)

## FHIR Server Integration[​](#fhir-server-integration "Direct link to FHIR Server Integration")
...
## Developer Utilities[​](#developer-utilities "Direct link to Developer Utilities")
...
```
import {  convertCcdaToFhir,  convertFhirToCcda,  convertXmlToCcda,  convertCcdaToXml,} from '@medplum/ccda';// Convert C-CDA to FHIRconst bundle = convertCcdaToFhir(ccda);// Convert FHIR to C-CDAconst ccda = convertFhirToCcda(bundle);// Load C-CDA from XMLconst ccda = convertXmlToCcda(xml);// Serialize C-CDA to XMLconst xml = convertCcdaToXml(ccda);
```

## Strategy and Alignment[​](#strategy-and-alignment "Direct link to Strategy and Alignment")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/integration/c-cda.md)
