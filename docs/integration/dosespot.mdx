---
title: "Overview"
description: "Medplum has partnered with , a leader in e-prescription (eRx) technology, to offer prescription ordering services for the . Medplum's e-prescribe functionality is exclusively available to providers directly engaged in patient care as part of ."
---
...
## DoseSpot FAQ[​](#dosespot-faq "Direct link to DoseSpot FAQ")
...
### Why does DoseSpot request credit card information?[​](#why-does-dosespot-request-credit-card-information "Direct link to Why does DoseSpot request credit card information?")
...
### What distinguishes a "Proxy" user from a "Prescriber" ?[​](#what-distinguishes-a-proxy-user-from-a-prescriber- "Direct link to What distinguishes a \"Proxy\" user from a \"Prescriber\" ?")
...
### Does Medplum support controlled substances prescriptions?[​](#does-medplum-support-controlled-substances-prescriptions "Direct link to Does Medplum support controlled substances prescriptions?")
...
### How do "Refill" and "Reorder" differ within Medplum?[​](#how-do-refill-and-reorder-differ-within-medplum "Direct link to How do \"Refill\" and \"Reorder\" differ within Medplum?")
...
### How does one initiate an Electronic Prior Authorization (ePA) with Medplum's eRx service?[​](#how-does-one-initiate-an-electronic-prior-authorization-epa-with-medplums-erx-service "Direct link to How does one initiate an Electronic Prior Authorization (ePA) with Medplum's eRx service?")
...
### Does Medplum support prescription submissions to pharmacies across all 50 states?[​](#does-medplum-support-prescription-submissions-to-pharmacies-across-all-50-states "Direct link to Does Medplum support prescription submissions to pharmacies across all 50 states?")
...
### What constitutes a transmission error in Medplum's eRx service?[​](#what-constitutes-a-transmission-error-in-medplums-erx-service "Direct link to What constitutes a transmission error in Medplum's eRx service?")
...
### Does Medplum offer drug references or educational materials for patients?[​](#does-medplum-offer-drug-references-or-educational-materials-for-patients "Direct link to Does Medplum offer drug references or educational materials for patients?")
...
### Can custom instructions be added to prescription notes in Medplum?[​](#can-custom-instructions-be-added-to-prescription-notes-in-medplum "Direct link to Can custom instructions be added to prescription notes in Medplum?")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/integration/dosespot/index.md)
