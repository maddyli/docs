...
description: "ADT stands for \"Admit, Discharge, Transfer.\" It is a type of HL7 message used in electronic health records systems to communicate changes in a patient's demographic or visit status. This includes registration, admission, discharge, and transfer information about a patient."
---
...
## Consuming ADT[​](#consuming-adt "Direct link to Consuming ADT")
...
## Publishing ADT[​](#publishing-adt "Direct link to Publishing ADT")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/integration/hl7-interfacing/adt.md)
