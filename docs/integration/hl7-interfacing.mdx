---
title: "Overview"
description: "Medplum  enables highly customizable HL7 interfacing engine that can be used as an alternative to Mirth or Corepoint. Medplum allows developers to , such as EHRs, LIS, RIS/PACS, billing systems and more."
---
...
```
MSH|^~\&|ADT1|MCM|LABADT|MCM|198808181126|SECURITY|ADT|MSG00001|P|2.1PID|||PATID1234^5^M11||JONES^WILLIAM^A^III||19610615|M-||C|1200 N ELM STREET^^GREENSBORO^NC^27401-1020|GL|(919)379-1212|(919)271-3434||S||PATID12345001^2^M10|123456789|987654^NCNK1|1|JONES^BARBARA^K|SPO|||||20011105PV1|1|I|2000^2012^01||||004777^LEBAUER^SIDNEY^J.|||SUR||-||1|A0-
```
...
## Connecting to Legacy Systems[​](#connecting-to-legacy-systems "Direct link to Connecting to Legacy Systems")
...
### Medplum Agent[​](#medplum-agent "Direct link to Medplum Agent")
...
### File Based HL7 Integrations[​](#file-based-hl7-integrations "Direct link to File Based HL7 Integrations")
...
### HL7 Aggregators[​](#hl7-aggregators "Direct link to HL7 Aggregators")
...
## Recommended Reading[​](#recommended-reading "Direct link to Recommended Reading")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/integration/hl7-interfacing/index.md)
