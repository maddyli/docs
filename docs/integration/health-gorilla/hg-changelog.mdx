...
description: "This page tracks updates, improvements, and changes to the HealthGorilla integration in Medplum."
---
...
## \[Aug 2025][​](#aug-2025 "Direct link to \[Aug 2025]")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/integration/health-gorilla/hg-changelog.md)
