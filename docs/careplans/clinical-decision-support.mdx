...
description: "Medplum enables building and delivering custom clinical decision support tools for a variety of applications. This guide focuses on the regulated ONC Criteria for Clinical Decision support which is criteria (a)(9) of the HTI criteria on predictive CDS."
---
...
<Warning>
  Medplum is not currently certified for (a)(9) but is pursuing certification. Contact us at [info@medplum.com](mailto:info@medplum.com) for details.
</Warning>

## Predictive[​](#predictive "Direct link to Predictive")
...
### Training Data[​](#training-data "Direct link to Training Data")
...
### Code Systems[​](#code-systems "Direct link to Code Systems")
...
### Insights Reporting[​](#insights-reporting "Direct link to Insights Reporting")
...
## Linked Referential[​](#linked-referential "Direct link to Linked Referential")
...
## Evidence Based[​](#evidence-based "Direct link to Evidence Based")
...
* [compliance](/docs/tags/compliance)

[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/careplans/clinical-decision-support.md)
