...
## RxNorm[​](#rxnorm "Direct link to RxNorm")
...
source: [https://www.nlm.nih.gov/research/umls/rxnorm/docs/appendix5.html](https://www.nlm.nih.gov/research/umls/rxnorm/docs/appendix5.html)

## NDC[​](#ndc "Direct link to NDC")
...
## Other Drug databases[​](#other-drug-databases "Direct link to Other Drug databases")

While this guide focuses on RxNorm and NDC, there are a few other popular drug databases in commercial use:

### First Databank (FDB)[​](#first-databank-fdb "Direct link to First Databank (FDB)")

[First Databank (FDB)](https://www.fdbhealth.com/) is a *private* company that provides drug databases covering various aspects of drug information, including drug interactions, contraindications, clinical decision support.
...
### National Drug Data File (NDB)[​](#national-drug-data-file-ndb "Direct link to National Drug Data File (NDB)")
...
* [medications](/docs/tags/medications)
* [rxnorm](/docs/tags/rxnorm)

[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/medications/medication-codes.md)
