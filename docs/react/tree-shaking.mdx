---
title: "Tree Shaking"
description: "Tree shaking, also known as dead code elimination, is a technique to keep JavaScript bundle sizes as small as possible."
---
...
## How to use Tree Shaking[​](#how-to-use-tree-shaking "Direct link to How to use Tree Shaking")
...
## How to verify it is working[​](#how-to-verify-it-is-working "Direct link to How to verify it is working")
...
![Medplum Hello World Tree Shaking](/images/docs/react/assets/images/tree-shaking-b48c98a6e5ae5bef8c3be1c06f6a2769.png)
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/react/tree-shaking.md)
