---
title: "Mantine 6.x to 7.x"
description: "Mantine 7.0 is a major release that introduces breaking changes. This guide will help you to migrate your application from Mantine 6.x to 7.x."
---
...
```
- "@mantine/core": "6.0.21",+ "@mantine/core": "7.3.2",
```

## Replace Emotion with PostCSS[​](#replace-emotion-with-postcss "Direct link to Replace Emotion with PostCSS")
...
```
- "@emotion/babel-plugin": "11.11.0",- "@emotion/react": "^11.11.1",- "@emotion/server": "11.11.0",+ "postcss": "8.4.31",+ "postcss-preset-mantine": "1.11.0",
```
...
```
+ import '@mantine/core/styles.css';+ import '@medplum/react/styles.css';
```

## createStyles[​](#createstyles "Direct link to createStyles")

The `createStyles` function is no longer available in Mantine 7.0. Use CSS Modules instead.

```
// 6.ximport { createStyles } from '@mantine/core';const useStyles = createStyles((theme) => ({  root: {    backgroundColor: theme.colors.red[5],  },}));
```

```
/* 7.0 */.root {  background-color: var(--mantine-color-red-5);}
```
...
## Other Prop Changes[​](#other-prop-changes "Direct link to Other Prop Changes")
...
[Edit this page](https://github.com/medplum/medplum/blob/main/packages/docs/docs/react/mantine-6x-to-7x.mdx)
